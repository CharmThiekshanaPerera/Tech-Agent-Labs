      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 xl:gap-8">
          {benefits.map((benefit, index) => (
            <AnimatedSection key={benefit.label} animation="scale" delay={index * 100}>
              <article
                className="gradient-border rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 text-center card-glow hover:card-glow-hover transition-all duration-300 group h-full"
              >
        ...
        {/* Social Proof */}
        <AnimatedSection className="mt-10 sm:mt-12 lg:mt-16 text-center" delay={400}>
