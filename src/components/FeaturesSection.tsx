    ...
    <section id="about" className="relative py-12 sm:py-16 md:py-24 lg:py-32">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <AnimatedSection className="text-center mb-10 sm:mb-12 lg:mb-16">
          <p className="text-primary font-medium text-sm sm:text-base mb-2 sm:mb-3">Why Teams Choose Us</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 xl:gap-8">
          {features.map((feature, index) => (
            <AnimatedSection key={feature.title} delay={index * 100}>
              <article
                className="group gradient-border rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 card-glow card-glow-hover transition-all duration-300 hover:-translate-y-2 h-full"
              >
                {/* Emoji & Icon */}
