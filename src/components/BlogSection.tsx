      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        {!loading && posts.length > 0 && (
          ...
          >
            ...
            <CarouselPrevious className="hidden sm:flex -left-4 lg:-left-6 bg-secondary/80 border-border hover:bg-primary hover:text-primary-foreground" />
            <CarouselNext className="hidden sm:flex -right-4 lg:-right-6 bg-secondary/80 border-border hover:bg-primary hover:text-primary-foreground" />
          </Carousel>
        )}
