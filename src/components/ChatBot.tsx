  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-14 right-4 sm:bottom-6 sm:right-6 z-50 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center group animate-bounce ${
      ...
      {/* Chat Window */}
      <div
        className={`fixed bottom-[5.5rem] right-2 sm:bottom-24 sm:right-6 z-50 w-[calc(100vw-16px)] sm:w-[380px] sm:max-w-[calc(100vw-48px)] max-h-[calc(100vh-6rem)] bg-card border border-border rounded-2xl shadow-2xl transition-all duration-300 overflow-hidden ${
          isOpen
